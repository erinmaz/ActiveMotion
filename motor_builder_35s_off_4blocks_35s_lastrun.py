...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.06), Sun Jan 10 12:17:38 2016
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/erin/Dropbox/Tasks/CalgaryMMDTIA/motor_builder_35s_off_4blocks_35s.psyexp',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    elif text.status == STARTED and t >= (0.0 + (35-win.monitorFramePeriod*0.75)): #most of one frame period left
...
trials_2 = data.TrialHandler(nReps=4, method=u'sequential', 
    extraInfo=expInfo, originPath='/Users/erin/Dropbox/Tasks/CalgaryMMDTIA/motor_builder_35s_off_4blocks_35s.psyexp',
    trialList=[None],
...
for thisTrial_2 in trials_2:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif text_2.status == STARTED and t >= (0.0 + (35-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif text_5.status == STARTED and t >= (0.0 + (35-win.monitorFramePeriod*0.75)): #most of one frame period left
